...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_edullisen_lounaan_voi_ostaa_kun_rahaa_vain_edullisen_lounaan_verran(self):
        kortti = Maksukortti(2.5)
        kortti.syo_edullisesti()
        self.assertEqual(str(kortti), "Kortilla on rahaa 0.0 euroa")

    def test_maukkaan_lounaan_voi_ostaa_kun_rahaa_vain_edullisen_lounaan_verran(self):
